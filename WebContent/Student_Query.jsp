...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" height="800">
  ...
  <tr height="440"><td><form action="StudentServlet?flag=query" method="post">
		    <table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="30" valign="top" ><h4>当前位置：<a href="Student.jsp">学生</a>——>查询成绩</h4></td>
		  </tr>
		  ...
		  <tr>
		    ...
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="StudentServlet?flag=query&pageNow=1&Cou_name=<%=cou_name %>">首页</a>		
		    <% if(pageNow!=1){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="StudentServlet?flag=query&pageNow=<%=pageNow-1 %>&Cou_name=<%=cou_name %>">上一页</a>
		    <%
		     }		    
		    %>
		      <% if(pageNow!=pageCount){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="StudentServlet?flag=query&pageNow=<%=pageNow+1 %>&Cou_name=<%=cou_name %>">下一页</a>
		    <%
		     }		    
		    %>   
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="StudentServlet?flag=query&pageNow=<%=pageCount %>&Cou_name=<%=cou_name %>">尾页</a>
		    &nbsp;&nbsp;&nbsp;&nbsp;
		      <label>
