...
<% 
	...
	ArrayList<String> Class_name=dbh.getClass_name("select Class_name from db_exam.class_tb");
...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" height="800">
  ...
  <tr height="440"><td><form action="ManagerServlet?flag=query" method="post">
		    <table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="30" valign="top" ><h4>当前位置：<a href="Manager.jsp">管理员</a>——>查询成绩</h4></td>
		  </tr>
		  ...
		  <tr >
			   ...
			   <option ></option>
			    <%			    			       
			     ...
			     <td>学生: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type="text  "  name ="Stu_name"   />  </td>		   
			  <td>  <input type="submit" name="query" id="query" value="查询" />
			    </label></td>
			   
		  </tr>
		  <tr>
		    <td height="280"><table width="150%" border="1" align="center">
		      <tr bgcolor="#FFFFCC">
		  ...
		  <tr>
		    ...
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=query&pageNow=1&Class_name=<%=class_name %>&Cou_name=<%=cou_name %>&Tea_name=<%=tea_name %>">首页</a>		
		    <% if(pageNow!=1){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=query&pageNow=<%=pageNow-1 %>&Class_name=<%=class_name %>&Cou_name=<%=cou_name %>&Tea_name=<%=tea_name %>">上一页</a>
		    <%
		     }		    
		    %>
		      <% if(pageNow!=pageCount){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a  href="ManagerServlet?flag=query&pageNow=<%=pageNow+1 %>&Class_name=<%=class_name %>&Cou_name=<%=cou_name %>&Tea_name=<%=tea_name %>"   
		                                   >下一页</a>
		    <%
		     }		    
		    %>   
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=query&pageNow=<%=pageCount %>&Class_name=<%=class_name %>&Cou_name=<%=cou_name %>&Tea_name=<%=tea_name %>">尾页</a>
		    &nbsp;&nbsp;&nbsp;&nbsp;
		      <label>
