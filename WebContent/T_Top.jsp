      ...
      <tr bgcolor="#CCCCCC">
       <td colspan="5" height="40"><table width="100%" border="0" align="center">
         <tr>
           ...
           <td width="15%"><div align="center" ><a href="TeacherServlet?flag=title&pageNow=1">在线出题</a></div></td>
           <td width="15%"><div align="center" ></div></td>
           <td width="15%"><div align="center" ><a href="TeacherServlet?flag=query&pageNow=1">查询成绩</a></div></td>
           <td width="15%"><div align="center" ></div></td>
           <td width="15%"><div align="center" ><a href="Teacher_psdAlter.jsp">修改密码</a></div></td>
           <td width="15%"><div align="center" ></div></td>
         </tr>
       </table></td>
      </tr>
