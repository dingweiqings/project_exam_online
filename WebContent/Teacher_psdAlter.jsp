...
<html>
  ...
  <tr height="440"><td><form action="TeacherServlet?flag=psdAlter" method="post" name="form1">
		    <table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="30" valign="top" ><h4>当前位置：<a href="Teacher.jsp">教师</a>——>修改密码</h4></td>
		  </tr>
		  <tr>
