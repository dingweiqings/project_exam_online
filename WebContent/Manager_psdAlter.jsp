...
<html>
  ...
  <tr height="440"><td><form action="ManagerServlet?flag=psdAlter" method="post" name="form1">
		    <table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="30" valign="top" ><h4>当前位置：<a href="Manager.jsp">管理员</a>——>修改密码</h4></td>
		  </tr>
		  <tr>
