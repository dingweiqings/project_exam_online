...
<% 
	...
	ArrayList<Course> al=(ArrayList<Course>)request.getAttribute("Course");
...
<html>
  ...
  function check(){
  	return window.confirm("你确定要删除该课程吗？");
  }
  </script>
...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" height="800">
  ...
  <tr height="440"><td><form action="ManagerServlet?flag=course" method="post">
		    <table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="30" valign="top" ><h4>当前位置：<a href="Manager.jsp">管理员</a>——>课程管理</h4></td>
		  </tr>
		 
	  	  <tr>
		      <td align="center" height="70"><h2>课程信息表</h2></td>
		  </tr>
		  <tr >
		  ...
		  <tr>
		    <td height="280"><table width="60%" border="1" align="center">
		      <tr bgcolor="#FFFFCC">
		        ...
		        <td align="center"><a href="Manager_Course_Add.jsp">添加课程</a></td>		        
		      </tr>
		      <% 
		      ...
		      <%
		        ...
		        <td align="center" height="25"><%=cou.getCou_ID() %></td>
		        <td align="center"><%=cou.getCou_name() %></td>		            
		        <td align="center"><a href="Manager_CourseServlet?flag=delete&Cou_ID=<%=cou.getCou_ID() %>" onClick="javascript:return check()">删除课程</a></td>
		      </tr>
		      		<%
		      	}
		      }
		  ...
		  <tr>
		    ...
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=course&pageNow=1&name=<%=name %>">首页</a>		
		    <% if(pageNow!=1){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=course&pageNow=<%=pageNow-1 %>&name=<%=name %>">上一页</a>
		    <%
		     }		    
		    %>
		      <% if(pageNow!=pageCount){		    
		    %>
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=course&pageNow=<%=pageNow+1 %>&name=<%=name %>">下一页</a>
		    <%
		     }		    
		    %>   
		    &nbsp;&nbsp;&nbsp;&nbsp;<a href="ManagerServlet?flag=course&pageNow=<%=pageCount %>&name=<%=name %>">尾页</a>
		    &nbsp;&nbsp;&nbsp;&nbsp;
		      <label>
