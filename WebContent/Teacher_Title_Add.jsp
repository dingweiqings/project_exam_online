...
<html>
  ...
  <tr height="540"><td><form action="Teacher_TitleServlet?flag=add" method="post" name="form1">
	<table width="920" border="0" align="center">
		  <tr>
		    <td align="left" height="50" valign="top" ><h4>当前位置：<a href="Teacher.jsp">教师</a>——><a href="TeacherServlet?flag=title">教师题库</a>——>添加题目</h4></td>
		  </tr>
		  <tr align="center">
				<td height="50"><h1>添加题目</h1></td>
		  </tr>
		  <tr>
		    <td align="center" height="440">
		    
		    	<table background="images/background.jpg" width="80%" height="440" border="1" bgcolor="#CCCCCC">
  <tr><td align="right" height="35" width="30%">选择课程&nbsp;&nbsp;&nbsp;:</td>
            <td align="left"><label>
  ...
  <tr>
    ...
    <td><label>
      <textarea name="Title_name" id="Title_name" cols="40" rows="3"></textarea>
    </label></td>
  </tr>
  <tr>
    <td align="right">选&nbsp;&nbsp;&nbsp;&nbsp;项&nbsp;&nbsp;&nbsp;&nbsp;A</td>
    <td><label>
      <textarea name="Title_opt_a" id="Title_opt_a" cols="40" rows="3"></textarea>
    </label></td>
  </tr>
  <tr>
    <td align="right">选&nbsp;&nbsp;&nbsp;&nbsp;项&nbsp;&nbsp;&nbsp;&nbsp;B</td>
    <td><label>
      <textarea name="Title_opt_b" id="Title_opt_b" cols="40" rows="3"></textarea>
    </label></td>
  </tr>
  <tr>
    <td align="right">选&nbsp;&nbsp;&nbsp;&nbsp;项&nbsp;&nbsp;&nbsp;&nbsp;C</td>
    <td><label>
      <textarea name="Title_opt_c" id="Title_opt_c" cols="40" rows="3"></textarea>
    </label></td>
  </tr>
  <tr>
    <td align="right">选&nbsp;&nbsp;&nbsp;&nbsp;项&nbsp;&nbsp;&nbsp;&nbsp;D</td>
    <td><label>
      <textarea name="Title_opt_d" id="Title_opt_d" cols="40" rows="3"></textarea>
    </label></td>
  </tr>
  <tr>
